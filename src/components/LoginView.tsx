...
import { Building, AlertCircle, Mail, Lock, UserPlus, LogIn } from 'lucide-react';
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code === 'auth/email-already-in-use') {
        ...
        setError('E-posta ile giriş şu anda kapalı. Lütfen Firebase Console üzerinden Email/Password sağlayıcısını aktifleştirin.');
      } else {
        setError('Bir hata oluştu. Lütfen bilgilerinizi kontrol edip tekrar deneyin. (' + err.code + ')');
      }
    } finally {
      setLoading(false);
    }
        ...
        <div className="bg-white py-8 px-4 shadow-xl shadow-slate-200/50 sm:rounded-2xl sm:px-10 border border-slate-100">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-10 p-2.5 border border-slate-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500" 
          ...
          <div className="space-y-6">
            <button 
              ...
              disabled={loading}
              type="button"
              className="w-full flex justify-center items-center gap-3 py-2.5 px-4 border border-slate-300 rounded-xl shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors disabled:opacity-50"
            >
